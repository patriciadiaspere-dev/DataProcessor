...
public class ReportController : ControllerBase
{
    ...
    public async Task<ActionResult<ReportResultResponse>> ProcessAmazonSales([FromForm] IFormFile file, CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> ExportAmazonSales([FromForm] IFormFile file, CancellationToken cancellationToken)
    {
        var user = await ResolveUserAsync(cancellationToken);
        await EnsureActiveStatusAsync(user, cancellationToken);
